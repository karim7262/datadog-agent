...
func (s Serializer) serializeStreamablePayload(payload marshaler.StreamJSONMarshaler, payloadBuilderPolicy jsonstream.PayloadBuilderPolicy) (forwarder.Payloads, http.Header, error) {
