...
build do
  ...
  block do
    ...
    nix_build_env = {
      "CFLAGS" => "-I#{install_dir}/embedded/include:/opt/mqm/inc",
      "CXXFLAGS" => "-I#{install_dir}/embedded/include:/opt/mqm/inc",
      "LDFLAGS" => "-L#{install_dir}/embedded/lib:/opt/mqm/lib64:/opt/mqm/lib",
      "LD_RUN_PATH" => "#{install_dir}/embedded/lib:/opt/mqm/lib64:/opt/mqm/lib",
